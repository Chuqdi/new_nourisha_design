...
export default function AboutPage() {
  ...
  return (
    <div className="w-full h-full relative pt-6">
      ...
      <div className="mx-6.25 flex flex-col gap-8 mt-32">
        <MessageBtn title="ABOUT US" />
        <div>
          <h4 className="text-[#7DB83A] text-center font-NewSpiritBold text-[4rem] ">
            Welcome to Nourisha
          </h4>
      ...
      <div className="flex flex-col md:flex-row gap-4 mx-6.25 my-[2rem]">
        {abouts.map((about, index) => (
          <div className="flex-1 gap-4 flex flex-col" key={`about_${index}`}>
            <h4 className="text-[#7DB83A] text-[2rem] font-NewSpiritBold">
              {about.title}
            </h4>
      ...
      <div className="px-6.25 flex flex-col gap-3 bg-[#F9FAFB] py-6.25">
